...
const Vf2_coolant = () => {
  const [formData, setFormData] = useState({
    ...
    const formKey = "vehicle factory2-COOLANT OIL FM";
    ...
    const messageStyle = {
        ...
        padding: "10px",
        borderRadius: "5px",
        backgroundColor: submitMessage.startsWith("✅") ? "#e6ffed" : "#ffe6e6",
        border: `1px solid ${submitMessage.startsWith("✅") ? "green" : "red"}`,
    };

    return (
        <div style={formStyle}>
            <h2 style={{ textAlign: "center" }}>VF2 - Coolant Filling Form</h2>
