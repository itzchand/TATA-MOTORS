...
const VF3_ClutchDataForm = () => {
  const [formData, setFormData] = useState({
    ...
    const formKey = "vehicle factory3-CLUTCH OIL FM";
    ...
    return (
        <div style={formStyle}>
            <h2 style={{ textAlign: "center" }}>VF3 - Clutch Filling Form</h2>
...
export default VF3_ClutchDataForm;