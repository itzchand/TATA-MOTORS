...
const VF2_ClutchDataForm = () => {
    ...
    const formKey = "vehicle factory2-CLUTCH OIL FM";
    ...
    return (
        <div style={formStyle}>
            <h2 style={{ textAlign: "center" }}>VF2 - Clutch Filling Form</h2>
...
export default VF2_ClutchDataForm;