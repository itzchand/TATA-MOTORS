...
const Vf2_powersteering= () => {
   const [formData, setFormData] = useState({
    ...
    const formKey = "vehicle factory2-POWER STEERING OIL FM";
    ...
    return (
        <div style={formStyle}>
            <h2 style={{ textAlign: "center" }}>VF2 - Power Steering Filling Form</h2>
...
export default Vf2_powersteering;